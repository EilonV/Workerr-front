    ...
    return (
        <section className='gig-preview'>
            ...
            <div className='gig-owner-info gig-owner-info-wrapper flex align-center'>
                {<img className='gig-owner-image' src={gig.owner.imgUrl} alt="gig owner image" />}
            ...
            <div className='gig-reviews-card flex'>
                ...
                {gig.owner.rate ? <p>&nbsp;{gig.owner.rate}</p> : <p>&nbsp;0</p>}
                <div className='flex'>
                    {gig.user[0].reviews ? (<p className='user-reviews-count'>({gig.user[0].reviews.length})</p>) : (<p className='user-reviews-count'>(0)</p>)}</div>
            </div>

            <div className='gig-footer flex space-between align-center'>
                <div className='gig-footer-icons flex align-center'>
                    <svg width="16" height="13" viewBox="0 0 16 13" xmlns="http://www.w3.org/2000/svg"><path fill="#b5b6ba" d="M15.0769 0H0.923077C0.413276 0 0 0.415736 0 0.928571C0 1.44141 0.413276 1.85714 0.923077 1.85714H15.0769C15.5867 1.85714 16 1.44141 16 0.928571C16 0.415736 15.5867 0 15.0769 0Z" /><path fill="#b5b6ba" d="M15.0769 5.57143H0.923077C0.413276 5.57143 0 5.98717 0 6.5C0 7.01284 0.413276 7.42857 0.923077 7.42857H15.0769C15.5867 7.42857 16 7.01284 16 6.5C16 5.98717 15.5867 5.57143 15.0769 5.57143Z" /><path fill="#b5b6ba" d="M15.0769 11.1429H0.923077C0.413276 11.1429 0 11.5586 0 12.0714C0 12.5843 0.413276 13 0.923077 13H15.0769C15.5867 13 16 12.5843 16 12.0714C16 11.5586 15.5867 11.1429 15.0769 11.1429Z" /></svg>
                    &nbsp;
