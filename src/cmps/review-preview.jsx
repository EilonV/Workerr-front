    ...
    return (
        <div className='seller-reviews flex column'>
            <div className='flex row gap'>
                <img className='user-review-img border-radius' src={review.by.imgUrl} alt="user avatar" />

                <div className='inner-container flex column'>

                    <div className=' user-name-svg flex row gap'>
                        <h4>{review.fullname}</h4><span>{review.rate}</span>
                    ...
                    <div className='user-country-flag flex row gap'>
                        <img src={review.by.flag} alt=""></img><span>{review.by.country}</span>
                    </div>
