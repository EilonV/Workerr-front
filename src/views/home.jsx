...
export const Home = () => {
  ...
  <div className='hero-background hero-mani'></div> */}
          ...
          <div className='hero-content'>
            <h1>
              Find the perfect <span className='italic-font'>freelance</span>{' '}
              <br /> services for your business
            </h1>
            <form className='home-search-box flex row'>
              <div className='search-icon flex justify-center'>
                <i>icon</i>
              </div>
              <input type='text' />
              <button>Search</button>
            </form>
            <div className='popular-categories flex gap'>
              Popular:
              {['logo design', 'artisitic', 'proffesional', 'accessible'].map(
                (tag, idx) => (
                  <span key={idx}>
                    <Link to={`/explore?filter=tags:${tag}`}>{tag}</Link>
                  </span>
                )
              )}
            </div>
        ...
        <div className='social-proof-line flex row gap justify-center'>
          Trusted by:
          <span>PlayBook</span>
          <span>Keygle</span>
          <span>BigNoise</span>
          ...
          <div className='about-us'>
            <div className='content'>
              ...
              <div>
                <h6>
                  {' '}
                  <span></span>The best for every budget
                </h6>
                <p>
              ...
              <div>
                <h6>
                  <span></span>Quality work done quickly
                </h6>
                <p>
              ...
              <div>
                <h6>
                  <span></span>Protected payments, every time
                </h6>
                <p>
